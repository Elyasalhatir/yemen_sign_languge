    ...
    constructor(manager, { index, name, parentIndex, childrenIndex, counterpartIndex, side }) {
        ...
        this._updateKalmanFilter = (_x, _y, _z) => {
            ...
            if (this.kalmanFilters === null) {
                // Tuned for maximum stability: very smooth motion
                this.kalmanFilters = {
                    x: new KalmanFilter(_x, 1, 1, 0.001, 0.1),
                    y: new KalmanFilter(_y, 1, 1, 0.001, 0.1),
                    z: new KalmanFilter(_z, 1, 1, 0.001, 0.1),
                }
            }
